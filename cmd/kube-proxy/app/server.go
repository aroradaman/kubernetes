...
func (o *Options) AddFlags(fs *pflag.FlagSet) {
	...
	fs.Int32Var(o.config.Conntrack.TCPBeLiberal, "conntrack-tcp-be-liberal", *o.config.Conntrack.TCPBeLiberal, "The value to set for nf_conntrack_tcp_be_liberal variable of netfilter conntrack system (-1 to leave as-is)")
