...
func (o *Options) processIncompatibleFlags(fs *pflag.FlagSet) {
	...
	if fs.Changed("iptables-sync-period") && o.config.Mode == kubeproxyconfig.ProxyModeIPTables {
		o.config.SyncPeriod.Duration = o.iptablesSyncPeriod
	}
	// iptables-min-sync-period
	if fs.Changed("iptables-min-sync-period") && o.config.Mode == kubeproxyconfig.ProxyModeIPTables {
