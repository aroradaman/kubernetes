...
func (o *Options) AddFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(o.config.Conntrack.TCPBeLiberal, "conntrack-tcp-be-liberal", *o.config.Conntrack.TCPBeLiberal, "Enable or Disable conntrack liberal mode by configuring nf_conntrack_tcp_be_liberal")
