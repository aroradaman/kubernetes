...
type KubeProxyConntrackConfiguration struct {
	...
	// tcpBeLiberal is the value kube-proxy will set for
	// nf_conntrack_tcp_be_liberal sysctl
	// (e.g. 1). Must be a non-negative integer to set.
	TCPBeLiberal *int32 `json:"tcpBeLiberal"`
