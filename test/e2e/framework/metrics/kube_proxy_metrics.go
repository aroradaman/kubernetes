...
// GetSingleDimensionMetricValue returns value for metric with only one dimension.
func (m *KubeProxyMetrics) GetSingleDimensionMetricValue(metricName string) float64 {
